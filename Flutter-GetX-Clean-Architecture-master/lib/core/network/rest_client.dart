...
class RestClient extends GetxService {
  ...
  Future<Response> createUser(String url, CreateUserRequesst? params) async {
    Response response;
  ...
  Future<Response> loginUser(String url) async {
    Response response;
  ...
  Future<Response> getUserName(String url) async {
    Response response;
