...
class LoginScreen extends GetView<LoginController> {
  ...
  void checkLogin(String email, String password) async {
    var getUserName = await controller.doLogin(email, password);
    if (getUserName != null) {
      Get.toNamed(SuccessfulScreen.routeName, arguments: getUserName);
    }
  }
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 45),
                    userInput(emailController, 'UserName', TextInputType.text),
